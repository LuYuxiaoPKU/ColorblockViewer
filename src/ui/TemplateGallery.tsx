      ...
      >
        <div className="gallery-head">
          ...
          <span className="gallery-hint muted">
            「复制命令」= 游戏内可直接粘贴的文本；「载入并执行」= 清空现有命令与粒子后执行
            （画布在左侧，可边看边试）
          </span>
